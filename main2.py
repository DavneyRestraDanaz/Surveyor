            ...
            html_content += f"""
                ...
                <div class="page" style="font-family: Arial; width: 21cm; height: 29.7cm; margin: 0 auto; padding: 1cm; position: relative;">
                    ...
                    <table class="psikogram" style="width: 100%; border-collapse: collapse; margin-top: 10px; font-family: Arial, sans-serif;">
                        ...
                        <tr>
                            <td style="width: 15%; padding: 10px; vertical-align: top; border: 1px solid black; font-weight: bold; font-size: 12px;">KEMAMPUAN INTELEKTUAL</td>
                            <td style="width: 80%; padding: 10px; text-align: justify; border: 1px solid black; font-size: 13px;">
                        ...
                        <tr>
                            <td style="padding: 10px; vertical-align: top; border: 1px solid black; font-weight: bold; font-size: 12px;">SIKAP DAN CARA KERJA</td>
                            <td style="padding: 10px; text-align: justify; border: 1px solid black; font-size: 13px;">
                        ...
                        <tr>
                            <td style="padding: 10px; vertical-align: top; border: 1px solid black; font-weight: bold; font-size: 12px;">KEPRIBADIAN</td>
                            <td style="padding: 10px; text-align: justify; border: 1px solid black; font-size: 13px;">
                                Berdasarkan pemeriksaan kepribadian, diketahui bahwa {gender_prefix} {nama} {' '.join(conclusion_texts["KEPRIBADIAN"])}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 10px; vertical-align: top; border: 1px solid black; font-weight: bold; font-size: 12px;">KEMAMPUAN BELAJAR</td>
                            <td style="padding: 10px; text-align: justify; border: 1px solid black; font-size: 13px;">
                    ...
                    <table class="psikogram" style="width: 100%; border-collapse: collapse; margin-top: 20px; font-family: Arial, sans-serif;">
                        ...
                        <tr>
                            <td style="width: 8%; text-align: center; border: 1px solid black; padding: 8px; font-size: 11px;">{"X" if selected_category == "Tahapan Normal" else ""}</td>
                            <td style="width: 25%; text-align: center; padding: 8px; border: 1px solid black; font-size: 11px;">Tahapan Normal</td>
                            <td style="padding: 8px; border: 1px solid black; font-size: 11px;">Individu tidak menunjukkan adanya gejala gangguan mental yang mengganggu fungsi sehari-hari.</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: center; border: 1px solid black; padding: 8px; font-size: 11px;">{"X" if selected_category == "Gejala Gangguan" else ""}</td>
                            <td style="text-align: center; padding: 8px; border: 1px solid black; font-size: 11px;">Gangguan</td>
                            <td style="padding: 8px; border: 1px solid black; font-size: 11px;">Individu menunjukkan gejala gangguan mental yang dapat mengganggu fungsi sehari-hari.</td>
                        </tr>
                    </table>
